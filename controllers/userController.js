...
const filterBody = (body, ...allowedFields) => {
  ...
  Object.keys(body).forEach(field => {
    if (allowedFields.includes(field)) newObject[field] = body[field];
  });
  return newObject;
};
...
exports.getAllUsers = factory.getAllDocuments(UserModel);
exports.getUser = factory.getDocumentById(UserModel);
